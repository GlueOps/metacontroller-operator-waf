...
def create_distribution(origin_domain_name, acm_certificate_arn, web_acl_id, domains, name_hashed, aws_resource_tags):
    ...
    limiter.allow_request_aws_cloudfront_create_distrubution()
...
def update_distribution(distribution_id, origin_domain_name, acm_certificate_arn, web_acl_id, domains):
    ...
    if differences:
        ...
        if differences:
            ...
            limiter.allow_request_aws_cloudfront_update_distrubution()
...
def get_live_distribution_status(distribution_id):
    ...
    limiter.allow_request_aws_cloudfront_get_distrubution()
...
def delete_distribution(distribution_id):
    ...
    if state["distribution_enabled"] == False and state["status"] != "InProgress":
        ...
        limiter.allow_request_aws_cloudfront_delete_distrubution()
